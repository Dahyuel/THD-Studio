...
export const StaggeredMenu = ({
  ...
  const menuButtonColor = isLight ? '#000000' : '#E2E61D';
  const openMenuButtonColor = isLight ? '#E2E61D' : '#000000';
  
  const colors = isLight 
    ? ['#0a0a0a', '#111111', '#000000'] 
    : ['#d1d51a', '#dbe01c', '#E2E61D'];

  const panelBgColor = isLight ? '#000000' : '#E2E61D';
  const accentColor = isLight ? '#E2E61D' : '#ffffff';
  const textColor = isLight ? '#ffffff' : '#000000';
  const changeMenuColorOnOpen = true;
  const [open, setOpen] = useState(false);
  
  // Reverse logo color when menu is open because the panel background contrasts with the site background
  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        ...
        <div className="flex items-center gap-3 pointer-events-auto">
          <img
            ...
            draggable={false}
            style={{ filter: logoFilter, cursor: 'pointer', transition: 'filter 0.3s ease' }}
      ...
      <aside id="staggered-menu-panel" ref={panelRef} className="staggered-menu-panel" aria-hidden={!open} style={{ backgroundColor: panelBgColor }}>
        <div className="sm-panel-inner">
            ...
            {items && items.length ? (
              items.map((it, idx) => (
                <li className="sm-panel-itemWrap" key={it.label + idx}>
                  <a 
                    className="sm-panel-item font-poppins font-bold transition-colors" 
              ...
              <li className="sm-panel-itemWrap" aria-hidden="true">
                <span className="sm-panel-item" style={{ color: textColor }}>
          ...
          {displaySocials && socialItems && socialItems.length > 0 && (
            <div className="sm-socials" aria-label="Social links">
              <h3 className="sm-socials-title font-poppins uppercase tracking-widest text-[0.7rem] mb-4" style={{ color: isLight ? 'rgba(255,255,255,0.4)' : 'rgba(0,0,0,0.4)' }}>Socials</h3>
